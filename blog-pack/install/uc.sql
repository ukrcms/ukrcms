...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uc_user` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `login` varchar(20) NOT NULL,  `name` varchar(30) DEFAULT NULL,  `password` varchar(60) NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `login` (`login`)) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Користувач, параметри користувача';
/*!40101 SET character_set_client = @saved_cs_client */;
