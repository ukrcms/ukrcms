...
CREATE TABLE `uc_categories` (  `id` int(8) NOT NULL AUTO_INCREMENT,  `title` varchar(255) NOT NULL,  `sef` varchar(255) NOT NULL,  `description` varchar(255) NOT NULL,  `status` tinyint(1) NOT NULL DEFAULT '0',  `order` smallint(6) NOT NULL DEFAULT '0',  `meta_description` text NOT NULL,  `meta_keywords` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uc_comments` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `post_id` int(11) DEFAULT '0',  `name` varchar(50) NOT NULL,  `url` varchar(100) NOT NULL,  `email` varchar(100) NOT NULL,  `comment` text NOT NULL,  `time` int(11) NOT NULL,  `status` tinyint(1) NOT NULL DEFAULT '0',  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uc_metatags` (  `id` varchar(40) NOT NULL,  `meta_title` varchar(255) NOT NULL,  `meta_description` text NOT NULL,  `meta_keywords` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uc_pages` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `title` varchar(255) DEFAULT NULL,  `sef` varchar(255) DEFAULT NULL,  `text` longtext,  `date` int(11) DEFAULT NULL,  `published` tinyint(1) NOT NULL DEFAULT '0',  `template` varchar(255) NOT NULL,  `meta_description` text NOT NULL,  `meta_keywords` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uc_posts` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `title` varchar(255) DEFAULT NULL,  `sef` varchar(255) DEFAULT NULL,  `shorttext` text NOT NULL,  `text` longtext,  `imageData` text NOT NULL,  `date` int(11) DEFAULT NULL,  `category_id` int(8) NOT NULL DEFAULT '0',  `published` tinyint(1) NOT NULL DEFAULT '0',  `meta_description` text NOT NULL,  `meta_keywords` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uc_settings` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `key` varchar(255) NOT NULL,  `value` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `uc_user` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `login` varchar(20) NOT NULL,  `name` varchar(30) DEFAULT NULL,  `password` varchar(255) NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `login` (`login`)) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Користувач, параметри користувача';
/*!40101 SET character_set_client = @saved_cs_client */;
LOCK TABLES `uc_user` WRITE;
/*!40000 ALTER TABLE `uc_user` DISABLE KEYS */;
INSERT INTO `uc_user` VALUES (1,'admin','Адміністратор','$2a$10$39a3599d19c24b648c96bOIaErWa7QA5ece.JVBxCMGEMUWDMXw4u');
